...
# creacion de la inception, codigo original de github
# Mejor modelo, tanto para las metricas como interpretacion
...
class InceptionV3(nn.Module):
    ...
    def __init__(
        ...
        self.Conv2d_1a_3x3 = BasicConv2d(1, 32, kernel_size=(3, 3), stride=(2, 2), padding=(0, 0))
    ...
    @torch.jit.unused
    def eager_outputs(self, x: Tensor, aux: Optional[Tensor]) -> Union[InceptionV3Outputs, Tensor]:
        if self.training and self.aux_logits:
            return InceptionV3Outputs(x, aux)
        else:
            return x

    def forward(self, x: Tensor) -> Union[InceptionV3Outputs, Tensor]:
