...
# creacion de la inception resnet, codigo original de github
...
class InceptionResnetv2Stem(nn.Module):
    def __init__(self):
        ...
        self.sub0conv1 = nn.Conv2d(1, 32, kernel_size=3, stride=2)
        self.sub0conv2 = nn.Conv2d(32, 32, kernel_size=3)
        self.sub0conv3 = nn.Conv2d(32, 64, kernel_size=3, padding=1)
        
        self.sub1p1_mpool1 = nn.MaxPool2d(kernel_size=3, stride=2)
        
        self.sub1p2_conv1 = nn.Conv2d(64, 80, kernel_size=3, stride=2)
        
        self.sub2p1_conv1 = nn.Conv2d(64, 80, kernel_size=1, padding=0)
...
class InceptionResnetv2A(nn.Module):
    def __init__(self, scale=True):
        ...
        self.p1_conv1 = nn.Conv2d(320, 32, kernel_size=1, padding=0)
        
        self.p2_conv1 = nn.Conv2d(320, 32, kernel_size=1, padding=0)
        self.p2_conv2 = nn.Conv2d(32, 32, kernel_size=3, padding=1)
        
        self.p3_conv1 = nn.Conv2d(320, 32, kernel_size=1, padding=0)
        self.p3_conv2 = nn.Conv2d(32, 48, kernel_size=3, padding=1)
        self.p3_conv3 = nn.Conv2d(48, 64, kernel_size=3, padding=1)
        
        self.p_conv1 = nn.Conv2d(128, 320, kernel_size=1, padding=0)
...
class InceptionResnetv2B(nn.Module):
    ...
    def __init__(self, scale=True):
        super().__init__()
        self.scale = scale
        self.p1_conv1 = nn.Conv2d(1088, 192, kernel_size=1, stride=1, padding=0)
        
        self.p2_conv1 = nn.Conv2d(1088, 128, kernel_size=1, padding=0)
        self.p2_conv2 = nn.Conv2d(128, 160, kernel_size=(1,7), padding=(0,3))
        self.p2_conv3 = nn.Conv2d(160, 192, kernel_size=(7,1), padding=(3,0))
        
        self.p3_conv = nn.Conv2d(384, 1088, kernel_size=1, padding=0)
...
class InceptionResnetv2C(nn.Module):
    def __init__(self, scale=True, noRelu=False):
        ...
        self.noRelu = noRelu
        self.p1_conv1 = nn.Conv2d(2080, 192, kernel_size=1, padding=0)
        
        self.p2_conv1 = nn.Conv2d(2080, 192, kernel_size=1, padding=0)
        self.p2_conv2 = nn.Conv2d(192, 224, kernel_size=(1,3), padding=(0,1))
        self.p2_conv3 = nn.Conv2d(224, 256, kernel_size=(3,1), padding=(1,0))
        
        self.p3_conv = nn.Conv2d(448, 2080, kernel_size=1, padding=0)
...
class InceptionResnetv2ReductionA(nn.Module):
    def __init__(self):
        ...
        self.p3_conv1 = nn.Conv2d(320, 256, kernel_size=1, padding=(0, 0))
        self.p3_conv2 = nn.Conv2d(256, 256, kernel_size=3, padding=1)
...
class InceptionResnetv2ReductionB(nn.Module):
    def __init__(self):
        ...
        self.p2_conv1 = nn.Conv2d(1088, 256, kernel_size=1, padding=0)
        self.p2_conv2 = nn.Conv2d(256, 384, kernel_size=3, stride=2)
        
        self.p3_conv1 = nn.Conv2d(1088, 256, kernel_size=1, padding=0)
        self.p3_conv2 = nn.Conv2d(256, 288, kernel_size=3, stride=2)
        
        self.p4_conv1 = nn.Conv2d(1088, 256, kernel_size=1, padding=0)
