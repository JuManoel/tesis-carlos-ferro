...
from models.kans.kans import mlp_kan, mlp_fastkan, mlp_kacn, mlp_kagn, mlp_kaln, mlp_wav_kan
...
def vggkan(input_channels, num_classes, groups: int = 1, spline_order: int = 3, grid_size: int = 5,
           base_activation: Optional[Callable[..., nn.Module]] = nn.GELU,
           grid_range: List = [-1, 1], dropout: float = 0.5, l1_decay: float = 0.001,
           dropout_linear: float = 0.5, vgg_type: str = 'VGG11', head_type: str = 'Linear',
           expected_feature_shape: Tuple = (7, 7), width_scale: int = 1, affine: bool = False,
           norm_layer: nn.Module = nn.InstanceNorm2d):
...
class FastVGGKAN(VGG, PyTorchModelHubMixin):
    def __init__(self, input_channels=1, num_classes=1, groups: int = 1, grid_size: int = 5,
                 base_activation: Optional[Callable[..., nn.Module]] = nn.GELU,
                 grid_range: List = [-1, 1], dropout: float = 0.5, l1_decay: float = 0.001,
                 dropout_linear: float = 0.5, vgg_type: str = 'VGG11', head_type: str = 'Linear',
                 expected_feature_shape: Tuple = (7, 7),
...
def fast_vggkan(input_channels=1, num_classes=1, groups: int = 1, grid_size: int = 3,
                base_activation: Optional[Callable[..., nn.Module]] = nn.GELU,
                grid_range: List = [-1, 1], dropout: float = 0.3, l1_decay: float = 0.01,
                dropout_linear: float = 0.3, vgg_type: str = 'VGG11', head_type: str = 'Linear',
                expected_feature_shape: Tuple = (7, 7),
                width_scale: int = 1, affine: bool = False,
...
def vggkagn(input_channels, num_classes, groups: int = 1, degree: int = 3, dropout: float = 0.5, l1_decay: float = 0.001,
            dropout_linear: float = 0.5, vgg_type: str = 'VGG11', head_type: str = 'Linear',
            expected_feature_shape: Tuple = (7, 7), width_scale: int = 1, affine: bool = False,
